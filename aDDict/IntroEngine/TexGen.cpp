 ...
 DeleteObject(bm);
  ...
  for (zx=0;zx<256;zx++)
    for (zy=0;zy<256;zy++)
     {
      ss=buffer[zx][zy];
      layers[incmnd.c.layer][zy][256-zx].a.r=(byte)(min(ss.a.r+layers[incmnd.c.layer][zy][256-zx].a.r,255.0));
      layers[incmnd.c.layer][zy][256-zx].a.g=(byte)(min(ss.a.g+layers[incmnd.c.layer][zy][256-zx].a.g,255.0));
      layers[incmnd.c.layer][zy][256-zx].a.b=(byte)(min(ss.a.b+layers[incmnd.c.layer][zy][256-zx].a.b,255.0));
     }
